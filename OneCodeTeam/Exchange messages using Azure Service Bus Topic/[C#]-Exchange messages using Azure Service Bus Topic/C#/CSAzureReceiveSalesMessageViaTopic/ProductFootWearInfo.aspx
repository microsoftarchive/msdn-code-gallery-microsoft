<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProductFootWearInfo.aspx.cs" Inherits="CSAzureReceiveSalesMessageViaTopic.ProductFootWearInfo"  MasterPageFile="~/WebMaster.Master"%>
...
<asp:Content ContentPlaceHolderID="ContentPlaceHolder_Content" runat="server" ID="cph_SalesOrderContent">
    ...
    <div style="margin: 5px 0px 0px 20px; width: 100%;overflow: scroll;height:300px;">
        <asp:Table ID="tbl_FootWearOrder" runat="server" CellPadding="0" Width="100%" CellSpacing="0" EnableViewState="true" ViewStateMode="Enabled">
       ...
       Product Infomation
        ...
        <asp:Table ID="tbl_ProductionDetails" runat="server" CellPadding="0" Width="100%" CellSpacing="0" EnableViewState="true" ViewStateMode="Enabled">
            ...
            <asp:TableRow ID="NameSpace_TableHead" CssClass="TableColHead">
                <asp:TableCell ID="cell_ProductFootWearOrderId" CssClass="TableCell">DetailsOrderId</asp:TableCell>
