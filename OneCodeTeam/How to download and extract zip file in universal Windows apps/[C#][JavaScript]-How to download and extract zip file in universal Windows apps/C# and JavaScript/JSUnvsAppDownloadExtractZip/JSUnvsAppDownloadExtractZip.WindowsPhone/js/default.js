...
(function () {
    ...
    app.onactivated = function (args) {
        if (args.detail.kind === activation.ActivationKind.launch
            || activation.ActivationKind.pickFolderContinuation) {
            ...
            {
                continueFolderPicker(args.detail.detail);
            }
    ...
    function continueFolderPicker(eventObject) {
        ...
        var priority = Windows.Networking.BackgroundTransfer.BackgroundTransferPriority.default;
        var requestUnconstrainedTransfer = false;

        var destinationFolder = eventObject[0].folder;
