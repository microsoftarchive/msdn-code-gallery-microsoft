...
void DirectXBase::CreateWindowSizeDependentResources()
{
	...
	inverseScale._11 = 1.0f / (ConvertDipsToPixels(m_windowBounds.Width) / m_windowBounds.Width);
	inverseScale._22 = 1.0f / (ConvertDipsToPixels(m_windowBounds.Height)/ m_windowBounds.Height);
