<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="WebForm1.aspx.vb" Inherits="TranslatorWebAppVB.WebForm1" %>
...
<body>
    ...
    <asp:Label ID="Label1" runat="server" Text="Enter Text"></asp:Label>
        <br />
        <asp:TextBox runat="server" ID="txtUser" Height="79px" TextMode="MultiLine" Width="452px"></asp:TextBox>
        <br />
