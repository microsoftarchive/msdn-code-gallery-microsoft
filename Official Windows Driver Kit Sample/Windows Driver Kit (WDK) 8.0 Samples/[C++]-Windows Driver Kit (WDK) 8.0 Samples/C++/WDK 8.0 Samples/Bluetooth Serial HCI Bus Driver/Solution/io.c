...
Routine Description:
    ...
    This is the completion function for sending HCI packet.  
...
--*/
{
    ...
    BOOLEAN HasOwnershipToComplete = TRUE;  
    ...
    {        
        // RequestFromBthport will be completed by the cancellation function.         
        HasOwnershipToComplete = FALSE;                      
