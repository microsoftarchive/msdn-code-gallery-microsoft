            ...
            return Windows.Devices.HumanInterfaceDevice.HidDevice.fromIdAsync(deviceInfo.id, Windows.Storage.FileAccessMode.readWrite).then(function (hidDevice) {
                ...
                if (hidDevice) {
                    ...
                    if (EventHandlerForDeviceClass.current._deviceConnectedCallback) {
                        EventHandlerForDeviceClass.current._deviceConnectedCallback(EventHandlerForDeviceClass.current, EventHandlerForDeviceClass.current._deviceInformation);
                    }

                    if (!EventHandlerForDeviceClass.current._isRegisteredForAppEvents) {
        ...
        _closeCurrentlyConnectedDevice: function () {
            if (this._device) {
                ...
                if (this._deviceCloseCallback) {
                    this._deviceCloseCallback(this, this._deviceInformation);
                }
