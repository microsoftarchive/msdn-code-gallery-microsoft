...
(function () {
    "use strict";
    var page = WinJS.UI.Pages.define("/html/s1-check-availability.html", {
            ...
            .then(function (consentAvailability) {
                switch (consentAvailability) {
                    ...
                    case Windows.Security.Credentials.UI.UserConsentVerifierAvailability.disabledByPolicy:
                        ...
                        break;
                    case Windows.Security.Credentials.UI.UserConsentVerifierAvailability.rtriesExhausted:
                    ...
                    case Windows.Security.Credentials.UI.UserConsentVerifierAvailability.deviceBusy:
                        ...
                        break;
                    default:
                        WinJS.log && WinJS.log("Consent verification with fingerprints is currently unavailable.", "sample", "error");
                        break;
                }
            });
        }
