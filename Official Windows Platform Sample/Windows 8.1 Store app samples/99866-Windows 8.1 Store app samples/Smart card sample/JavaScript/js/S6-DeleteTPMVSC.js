...
(function () {
    "use strict";
    var page = WinJS.UI.Pages.define("/html/S6-DeleteTPMVSC.html", {
    ...
    function Delete_Click() {
        ...
        function (result) {
            if (result) {
                WinJS.log("TPM virtual smart card deletion completed.",
                          "sample",
                          "status");
    ...
    function handleCardRemoved(eventArgs) {
        WinJS.log("Card removed from reader " + eventArgs.target.name + ".",
                  "sample",
                  "status");
    }
})();
