...
(function () {
    "use strict";
    var page = WinJS.UI.Pages.define("/html/S3-ResetPin.html", {
    ...
    function ResetPin_Click() {
        ...
        function (result) {
            if (result) {
                WinJS.log("Smart card PIN reset operation completed.",
                          "sample",
                          "status");
            }
            else {
                WinJS.log("Smart card PIN reset operation was canceled by " +
                          "the user.",
                          "sample",
                          "status");
            }
