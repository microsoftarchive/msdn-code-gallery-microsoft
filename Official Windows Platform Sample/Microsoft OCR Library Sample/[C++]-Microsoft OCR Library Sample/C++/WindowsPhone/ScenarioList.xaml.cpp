...
WindowsPhone::ScenarioList::ScenarioList()
{
	InitializeComponent();
}
...
void WindowsPhone::ScenarioList::OnNavigatedTo(NavigationEventArgs^ e)
{
...
void WindowsPhone::ScenarioList::ScenarioControl_SelectionChanged(Object^ sender, SelectionChangedEventArgs^ e)
{
...
void WindowsPhone::ScenarioList::Footer_Click(Object^ sender, RoutedEventArgs^ e)
{
