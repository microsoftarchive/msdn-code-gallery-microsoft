...
namespace AppUIBasics.ControlPages
{
    ...
    /// </summary>
    public sealed partial class ListViewPage : ControlPage
    {
        ...
        protected async override void OnNavigatedTo(NavigationEventArgs e)
        {
            ...
            Control1.ItemsSource = _controlInfoDataGroups;
        }
        ...
        {
            Control1.ItemTemplate = (DataTemplate)this.Resources["ImageTextListTemplate"];
        }

        private void TextButton_Click(object sender, RoutedEventArgs e)
        {
            Control1.ItemTemplate = (DataTemplate)this.Resources["ImageTextListMailFolderTemplate"];
        }
