...
namespace AppUIBasics
{
    ...
    sealed partial class App : Application
    {
            ...
            SettingsPaneCommandsRequestedEventArgs args)
        {
            ...
            var helpFlyoutLabel = resourceLoader.GetString("helpFlyoutLabel");

            args.Request.ApplicationCommands.Add(new SettingsCommand("Help", helpFlyoutLabel, _ => ShowHelpSettingsFlyout()));
        }
        ...
        {
            HelpSettingsFlyout helpSettingsFlyout = new HelpSettingsFlyout();
