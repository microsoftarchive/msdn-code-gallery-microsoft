...
namespace AppUIBasics
{
    ...
    public sealed partial class SearchResultsPage : Page
    {
        ...
        public Dictionary<String, IEnumerable<AppUIBasics.Data.ControlInfoDataItem>> Results
        {
            get;
            set;
        }
        ...
        private async void navigationHelper_LoadState(object sender, LoadStateEventArgs e)
        {
            ...
            Results = new Dictionary<string, IEnumerable<Data.ControlInfoDataItem>>();
            ...
            if (selectedFilter != null)
            {
                ...
                else if (Results.ContainsKey(selectedFilter.Name))
                {
                    this.DefaultViewModel["Results"] =
                      new List<AppUIBasics.Data.ControlInfoDataItem>(Results[selectedFilter.Name]);
                }
