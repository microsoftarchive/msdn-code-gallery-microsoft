...
namespace BTLE_Explorer
{
    ...
    public sealed partial class App : Application
    {
        ...
        public App()
        {
            ...
            // Add unhandled and unobserved exception handlers
        ...
        private async void OnSuspending(object sender, SuspendingEventArgs e)
        {
            ...
            // Since we don't want to drain device battery, unregister them.
            await GlobalSettings.UnregisterAllNotificationsAsync();
