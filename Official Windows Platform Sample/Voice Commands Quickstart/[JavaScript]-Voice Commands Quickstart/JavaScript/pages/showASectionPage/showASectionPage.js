...
(function () {
	...
	WinJS.UI.Pages.define("/pages/showASectionPage/showASectionPage.html", {
		...
		ready: function (element, options) {
			...
			if (parameters.length > 1) {
				var newspaperSectionParagraph = element.querySelector("#newspaperSectionParagraph");
				newspaperSectionParagraph.innerText = parameters[1];
				var feedbackParagraph = element.querySelector("#feedbackParagraph");
				feedbackParagraph.innerText = "VoiceCommandsQuickstart has launched and has navigated to the " + newspaperSectionParagraph.innerText + " newspaper section.";
