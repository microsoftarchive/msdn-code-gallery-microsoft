...
(function () {
    "use strict";
    var page = WinJS.UI.Pages.define("/html/S2-ChangePin.html",
        {
    ...
    function ChangePin_Click() {
        ...
        function (result) {
            if (result) {
                WinJS.log("Smart card change PIN operation completed.",
                          "sample",
                          "status");
            }
            else {
                WinJS.log("Smart card change PIN operation was canceled by " +
                          "the user.",
                          "sample",
                          "status");
            }
