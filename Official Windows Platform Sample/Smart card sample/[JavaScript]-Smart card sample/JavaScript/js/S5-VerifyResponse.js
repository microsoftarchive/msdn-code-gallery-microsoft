...
(function () {
    "use strict";
    var page = WinJS.UI.Pages.define("/html/S5-VerifyResponse.html", {
        ready: function (element, options) {
            document.getElementById("VerifyResponse").addEventListener(
                "click",
                VerifyResponse_Click,
                false);
        }
    });
    ...
    function VerifyResponse_Click() {
        ...
        function (result) {
            WinJS.log("Smart card response verification completed. Result: " +
                      result,
                      "sample",
                      "status");
