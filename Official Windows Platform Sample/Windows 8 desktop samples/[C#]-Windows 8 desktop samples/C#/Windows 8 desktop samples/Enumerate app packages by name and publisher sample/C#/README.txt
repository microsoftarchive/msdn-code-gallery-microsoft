...
Prerequisites
=============
This sample requires Windows 8+.
This sample requires Visual Studio 11 Ultimate Developer Preview.
...
To build the sample using Visual Studio 11 Ultimate Developer Preview (preferred method):
================================================
