...
// or VSDllUnregisterServer. For sample code we set as default the experimental hive, but for production
// code you should change it to the standard VisualStudio hive that is LREGKEY_VISUALSTUDIOROOT.
