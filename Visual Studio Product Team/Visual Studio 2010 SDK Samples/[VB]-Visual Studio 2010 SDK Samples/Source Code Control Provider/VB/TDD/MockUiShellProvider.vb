...
Namespace Microsoft.Samples.VisualStudio.SourceControlIntegration.SccProvider.UnitTests
	Friend Class MockUiShellProvider
		...
		''' </summary>
		''' <returns></returns>
		Friend Shared Function GetShowMessageBoxYes() As BaseMock
			Dim uiShell As BaseMock = GetUiShellInstance()
			Dim name As String = String.Format("{0}.{1}", GetType(IVsUIShell).FullName, "ShowMessageBox")
			uiShell.AddMethodCallback(name, New EventHandler(Of CallbackArgs)(AddressOf ShowMessageBoxYes))
			Return uiShell
		End Function
		...
		Private Shared Sub NextCallBack2(ByVal caller As Object, ByVal arguments As CallbackArgs)
			...
			Dim properties As Dictionary(Of Integer, Object) = New Dictionary(Of Integer,Object)()
		...
		Private Shared Sub ShowMessageBoxYes(ByVal caller As Object, ByVal arguments As CallbackArgs)
