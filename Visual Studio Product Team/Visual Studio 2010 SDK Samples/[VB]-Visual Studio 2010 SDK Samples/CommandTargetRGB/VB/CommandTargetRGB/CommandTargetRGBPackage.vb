...
Public NotInheritable Class CommandTargetRGBPackage
    ...
    Private Sub ShowToolWindow(ByVal sender As Object, ByVal e As EventArgs)
        ...
        While True
            ...
            Dim currentWindow As ToolWindowPane = Me.FindToolWindow(GetType(RGBToolWindow), i, False)
            If currentWindow Is Nothing Then
                ' Create the window with the first free ID.
                Dim window As RGBToolWindow = Me.CreateToolWindow(GetType(RGBToolWindow), i)
