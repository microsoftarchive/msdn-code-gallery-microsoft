	...
	public class ClientPackage : Package
	{
		...
		protected override void Initialize()
		{
			...
			if (null == mcs)
			{
				...
				Trace.WriteLine("Can not get the OleMenuCommandService from the base class.");
				return;
			}
		...
		private void GetLocalServiceCallback(object sender, EventArgs args)
		{
			...
			if (null != service)
			{
				...
				Trace.WriteLine("GetService for the local service succeeded, but it should fail.");
				return;
			}
