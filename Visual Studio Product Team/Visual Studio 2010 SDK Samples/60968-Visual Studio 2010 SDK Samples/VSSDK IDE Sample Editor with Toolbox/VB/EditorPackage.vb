...
#Region "Constructors"
        ...
        ''' </summary>
        Public Sub New()
            Trace.WriteLine(String.Format(CultureInfo.CurrentCulture, "Entering constructor for: {0}", GetType(EditorPackage).ToString()))
        End Sub
...
#Region "Methods"
        ...
        Protected Overrides Sub Initialize()
            Trace.WriteLine(String.Format(CultureInfo.CurrentCulture, "Entering Initialize() of: {0}", GetType(EditorPackage).ToString()))
