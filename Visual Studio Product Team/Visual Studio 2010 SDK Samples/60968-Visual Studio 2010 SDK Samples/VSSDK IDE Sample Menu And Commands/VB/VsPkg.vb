...
#Region "Commands Actions"
        ...
        Private Sub OutputCommandString(ByVal text As String)
            ...
            Dim outputWindow As IVsOutputWindow = TryCast(GetService(GetType(SVsOutputWindow)), IVsOutputWindow)
            ' If we fail to get it we can exit now.
            If Nothing Is outputWindow Then
            ...
            If Microsoft.VisualStudio.ErrorHandler.Failed(outputWindow.GetPane(guidGeneral, windowPane)) Then
