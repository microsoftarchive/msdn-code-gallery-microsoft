...
Namespace Samples.EditorToolwindow
    ...
    Guid(GuidList.guidEditorToolwindowPkgString)>
    Public NotInheritable Class EditorToolwindowPackage
        Inherits Package
...
#Region "Package Members"
        ...
        Protected Overrides Sub Initialize()
            ...
            If Nothing IsNot mcs Then
                ...
                Dim toolwndCommandID As New CommandID(GuidList.guidEditorToolwindowCmdSet, CInt(Fix(PkgCmdIDList.editorToolwindow)))
                Dim menuToolWin As New MenuCommand(AddressOf ShowToolWindow, toolwndCommandID)
