...
#Region "Ordering Operators"
    ...
    Public Sub DataSetLinq31()
        ...
        Dim sortedWords = words3.OrderBy(Of String)(Function(row) row("word"), _
    ...
    Public Sub DataSetLinq34()
        ...
        Dim sortedWords = words3.OrderByDescending(Of String)( _
    ...
    Public Sub DataSetLinq38()
        ...
        Dim sortedWords = words3.OrderBy(Of String)(Function(row) row!word.Length).ThenByDescending(Of String)( _
                                         Function(row) row!word, New CaseInsensitiveComparer())
    ...
    Public Sub DataSetLinq45()
        ...
        Dim orderGroups = anagrams.GroupBy(Of String, String)(Function(row) row("anagram").Trim(), _
    ...
    Private Sub CreateCustomersTable()
        ...
        For Each cust In customerList
            ...
            For Each e In cust.MyOrders
                orders.Rows.Add(e.<id>.Value, cust.CustomerID, e.<orderdate>.Value, Convert.ToDecimal(e.<total>.Value, New System.Globalization.CultureInfo("en-US")))
            Next
        Next
