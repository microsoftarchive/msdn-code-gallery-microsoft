...
Namespace Microsoft.Samples.VisualStudio.CodeSweep
    ...
    Public Class Utilities
        ...
        Public Const RemotingChannel As Integer = 9000

        Public Shared Function GetRemotingUri(procId As Integer, includeLocalHostPrefix As Boolean) As String
            If includeLocalHostPrefix Then
