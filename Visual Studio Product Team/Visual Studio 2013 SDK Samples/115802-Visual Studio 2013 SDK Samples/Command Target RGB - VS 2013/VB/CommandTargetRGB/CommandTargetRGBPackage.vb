...
ProvideToolWindow(GetType(RGBToolWindow), MultiInstances:=True), _
Guid(GuidList.guidCommandTargetRGBPkgString)> _
Public NotInheritable Class CommandTargetRGBPackage
    Inherits Package
    ...
    Private Sub ShowToolWindow(ByVal sender As Object, ByVal e As EventArgs)
        ...
        Dim id As Integer = FindUnusedToolWindowId(GetType(RGBToolWindow))

        ' Create the window with the first free ID.
        Dim window As RGBToolWindow = Me.CreateToolWindow(GetType(RGBToolWindow), id)
    ...
    Private Function FindUnusedToolWindowId(ByVal toolWindowType As Type) As Integer
        Dim id As Integer = 0

        While True
            Dim window As ToolWindowPane = MyBase.FindToolWindow(toolWindowType, id, False)
...
#Region "Package Members"
    ...
    Protected Overrides Sub Initialize()
        ...
        If Not mcs Is Nothing Then
            ...
            Dim toolwndCommandID As New CommandID(GuidList.guidCommandTargetRGBCmdSet, CInt(PkgCmdIDList.cmdidShowToolWindow))
