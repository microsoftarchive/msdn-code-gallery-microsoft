...
Namespace Microsoft.Samples.VisualStudio.CodeSweep.VSPackage
    Friend Class Task
        ...
        Public Property Ignored() As Boolean
            Get
                If String.IsNullOrEmpty(_projectFile) Then
                    Return False
                End If
...
#End Region ' IVsTaskItem Members
...
#Region "IVsTaskItem3 Members"
            ...
            Select Case CType(iField, TaskFields)
                ...
                Case TaskFields.Project
                    ...
                    If _projectFile IsNot Nothing AndAlso _projectFile.Length > 0 Then
                        pvarValue = If(ProjectUtilities.GetUniqueProjectNameFromFile(_projectFile), String.Empty)
                    Else
                        pvarValue = String.Empty
                    End If
        ...
        Public Function OnLinkClicked(ByVal iField As Integer, ByVal iLinkIndex As Integer) As Integer Implements IVsTaskItem3.OnLinkClicked
            Dim startFinder As TextFinder = Function(text, startIndex) text.IndexOf("@", startIndex)
            Dim endFinder As TextFinder = Function(text, startIndex) text.IndexOf("@", startIndex + 1)
...
#End Region ' IVsTaskItem3 Members
...
#Region "Private Members"
        ...
        Private Shared Function ParseLinks(ByVal text As String) As String
            Dim startFinder As TextFinder = Function(text2, startIndex) text2.IndexOf("http://", startIndex)

            Dim endFinder As TextFinder =
                Function(text2, startIndex)
