...
namespace Microsoft.Samples.VisualStudio.CodeSweep.VSPackage
{
    class TaskProvider : ITaskProvider, IVsSolutionEvents
    {
        ...
        public void AddResult(IScanResult result, string projectFile)
        {
            ...
            if (result.Scanned)
            {
                foreach (IScanHit hit in result.Results)
                {
                    if (!String.IsNullOrEmpty(hit.Warning))
                    {
                        ...
                        {
                            _tasks.Add(new Task(hit.Term.Text, hit.Term.Severity, hit.Term.Class, hit.Warning, String.Empty, String.Empty, -1, -1, String.Empty, String.Empty, this, _serviceProvider));
            ...
            {
                _tasks.Add(new Task(String.Empty, 1, String.Empty, String.Format(CultureInfo.CurrentUICulture, Resources.FileNotScannedError, fullPath), String.Empty, fullPath, -1, -1, projectFile, String.Empty, this, _serviceProvider));
            }
            Refresh();
        }
