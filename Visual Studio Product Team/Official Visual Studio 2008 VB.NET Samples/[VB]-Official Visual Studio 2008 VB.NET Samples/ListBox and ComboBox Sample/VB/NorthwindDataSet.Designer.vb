...
Partial Public Class NorthwindDataSet
    ...
    Partial Public Class EmployeesDataTable
        ...
        Public Overloads Function AddEmployeesRow( _
                    ...
                    ByVal rowguid As System.Guid) As EmployeesRow
            Dim rowEmployeesRow As EmployeesRow = CType(Me.NewRow,EmployeesRow)
            Dim columnValuesArray() As Object = New Object() {Nothing, LastName, FirstName, Title, TitleOfCourtesy, BirthDate, HireDate, Address, City, _Region, PostalCode, Country, HomePhone, Extension, Photo, Notes, Nothing, PhotoPath, rowguid}
    ...
    Partial Public Class EmployeesRow
        ...
        Public Property rowguid() As System.Guid
            Get
                Return CType(Me(Me.tableEmployees.rowguidColumn),Global.System.Guid)
            End Get
            Set
                Me(Me.tableEmployees.rowguidColumn) = value
            End Set
        End Property
    ...
    Partial Public Class EmployeesTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Employees] WHERE (([EmployeeID] = @Original_EmployeeID) AND (["& _ 
                ...
                " OR ([PhotoPath] = @Original_PhotoPath)) AND ([rowguid] = @Original_rowguid))"
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Employees] ([LastName], [FirstName], [Title], [TitleOfCourtesy"& _ 
                ...
                ", [HomePhone], [Extension], [Photo], [Notes], [ReportsTo], [PhotoPath], [rowguid"& _ 
                "]) VALUES (@LastName, @FirstName, @Title, @TitleOfCourtesy, @BirthDate, @HireDat"& _ 
                "e, @Address, @City, @Region, @PostalCode, @Country, @HomePhone, @Extension, @Pho"& _ 
                "to, @Notes, @ReportsTo, @PhotoPath, @rowguid);"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT EmployeeID, LastName, Fir"& _ 
                "stName, Title, TitleOfCourtesy, BirthDate, HireDate, Address, City, Region, Post"& _ 
                "alCode, Country, HomePhone, Extension, Photo, Notes, ReportsTo, PhotoPath, rowgu"& _ 
                "id FROM Employees WHERE (EmployeeID = SCOPE_IDENTITY())"
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Employees] SET [LastName] = @LastName, [FirstName] = @FirstName, [T"& _ 
                ...
                "tsTo, [PhotoPath] = @PhotoPath, [rowguid] = @rowguid WHERE (([EmployeeID] = @Ori"& _ 
                "ginal_EmployeeID) AND ([LastName] = @Original_LastName) AND ([FirstName] = @Orig"& _ 
                "inal_FirstName) AND ((@IsNull_Title = 1 AND [Title] IS NULL) OR ([Title] = @Orig"& _ 
                "inal_Title)) AND ((@IsNull_TitleOfCourtesy = 1 AND [TitleOfCourtesy] IS NULL) OR"& _ 
                " ([TitleOfCourtesy] = @Original_TitleOfCourtesy)) AND ((@IsNull_BirthDate = 1 AN"& _ 
                "D [BirthDate] IS NULL) OR ([BirthDate] = @Original_BirthDate)) AND ((@IsNull_Hir"& _ 
                "eDate = 1 AND [HireDate] IS NULL) OR ([HireDate] = @Original_HireDate)) AND ((@I"& _ 
                ...
                "ull_Region = 1 AND [Region] IS NULL) OR ([Region] = @Original_Region)) AND ((@Is"& _ 
                "Null_PostalCode = 1 AND [PostalCode] IS NULL) OR ([PostalCode] = @Original_Posta"& _ 
                "lCode)) AND ((@IsNull_Country = 1 AND [Country] IS NULL) OR ([Country] = @Origin"& _ 
                "al_Country)) AND ((@IsNull_HomePhone = 1 AND [HomePhone] IS NULL) OR ([HomePhone"& _ 
                "] = @Original_HomePhone)) AND ((@IsNull_Extension = 1 AND [Extension] IS NULL) O"& _ 
                "R ([Extension] = @Original_Extension)) AND ((@IsNull_ReportsTo = 1 AND [ReportsT"& _ 
                "o] IS NULL) OR ([ReportsTo] = @Original_ReportsTo)) AND ((@IsNull_PhotoPath = 1 "& _ 
                "AND [PhotoPath] IS NULL) OR ([PhotoPath] = @Original_PhotoPath)) AND ([rowguid] "& _ 
                "= @Original_rowguid));"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT EmployeeID, LastName, FirstName, Title, TitleOfCo"& _ 
                "urtesy, BirthDate, HireDate, Address, City, Region, PostalCode, Country, HomePho"& _ 
                "ne, Extension, Photo, Notes, ReportsTo, PhotoPath, rowguid FROM Employees WHERE "& _ 
        ...
        Private Sub InitConnection()
            ...
            Me._connection.ConnectionString = Global.ListBoxComboBox.Settings.Default.NorthwindConnectionString
        End Sub
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT EmployeeID, LastName, FirstName, Title, TitleOfCourtesy, BirthDate, HireDa"& _ 
                ...
                "es, ReportsTo, PhotoPath, rowguid FROM dbo.Employees"
        ...
        Public Overloads Overridable Function Delete( _
            ...
            End If
            Me.Adapter.DeleteCommand.Parameters(29).Value = CType(Original_rowguid,System.Guid)
        ...
        Public Overloads Overridable Function Insert( _
                    ...
                    ByVal PhotoPath As String,  _
                    ByVal rowguid As System.Guid) As Integer
            ...
            End If
            Me.Adapter.InsertCommand.Parameters(17).Value = CType(rowguid,System.Guid)
        ...
        Public Overloads Overridable Function Update( _
            ...
            End If
            Me.Adapter.UpdateCommand.Parameters(17).Value = CType(rowguid,System.Guid)
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(46).Value = CType(Original_PhotoPath,String)
            End If
            Me.Adapter.UpdateCommand.Parameters(47).Value = CType(Original_rowguid,System.Guid)
            Me.Adapter.UpdateCommand.Parameters(48).Value = CType(EmployeeID,Integer)
