...
Partial Public Class NORTHWND
  ...
  #End Region
	...
	Public Function CustomerOrderHistory(<Parameter(Name:="CustomerID", DbType:="NChar(5)")> ByVal customerID As String) As ISingleResult(Of CustOrderHistResult)
	...
	Public Function CustomerTotalSales(<Parameter(Name:="CustomerID", DbType:="NChar(5)")> ByVal customerID As String, <Parameter(Name:="TotalSales", DbType:="Money")> ByRef totalSales As System.Nullable(Of Decimal)) As <Parameter(DbType:="Int")> Integer
	...
	<FunctionAttribute(Name:="dbo.Get Customer And Orders"),  _
	 ResultType(GetType(CustomerResultSet)),  _
	 ResultType(GetType(OrdersResultSet))>  _
	...
	<FunctionAttribute(Name:="dbo.Whole Or Partial Customers Set"),  _
	 ResultType(GetType(WholeCustomersSetResult)),  _
	 ResultType(GetType(PartialCustomersSetResult))>  _
...
<Table(Name:="dbo.Contacts"),  _
 InheritanceMapping(Code:="Unknown", Type:=GetType(Contact), IsDefault:=true),  _
...
Partial Public Class Contact
	...
	<Column(Storage:="_ContactType", DbType:="NVarChar(50)", IsDiscriminator:=true)>  _
	Public Property ContactType() As String
		Get
			Return Me._ContactType
		End Get
...
Partial Public Class Employee
	...
	<Association(Name:="Employee_Employee", Storage:="_ReportsToEmployee", ThisKey:="ReportsTo", IsForeignKey:=true)>  _
...
Partial Public Class OrderDetail
	...
	<Association(Name:="Order_OrderDetail", Storage:="_Order", ThisKey:="OrderID", IsForeignKey:=true)>  _
	...
	<Association(Name:="Product_OrderDetail", Storage:="_Product", ThisKey:="ProductID", IsForeignKey:=true)>  _
...
Partial Public Class [Order]
	...
	<Association(Name:="Order_OrderDetail", Storage:="_OrderDetails", OtherKey:="OrderID")>  _
...
Partial Public Class Product
	...
	<Association(Name:="Product_OrderDetail", Storage:="_OrderDetails", OtherKey:="ProductID")>  _
	Public Property OrderDetails() As EntitySet(Of OrderDetail)
		Get
			Return Me._OrderDetails
		End Get
