...
<%@ Control Language="VB" AutoEventWireup="true" CodeBehind="AZURE_UpdatingWebPartUserControl.ascx.vb" Inherits="AZURE_UpdatingWebPart.AZURE_UpdatingWebPartUserControl" %>
