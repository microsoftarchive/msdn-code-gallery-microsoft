...
<%@ Control Language="VB" AutoEventWireup="true" CodeBehind="HTMLAudioWebPartUserControl.ascx.vb" Inherits="CLIENTSIDE_HTML5AudioObject.HTMLAudioWebPartUserControl" %>
