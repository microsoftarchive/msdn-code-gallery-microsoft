...
<asp:Content ID="PageHead" ContentPlaceHolderID="PlaceHolderAdditionalPageHead" runat="server">
    ...
    <!-- These are the main scripts that update the Web object -->
    <script type="text/javascript">
        //This variable will hold a reference to the web object
        var web = null;

        //This function sets, updates, and runs a asynchronous query to edit web properties
        function setWebDetails() {
            //Get the current context
            var context = new SP.ClientContext();
            //Get the current web
            web = context.get_web();
            //Set some properties of the web object
            web.set_title('JavaScript Set this Title Via CSOM');
            web.set_description('JavaScript set this description via CSOM');
            //Update the object
            web.update();
        ...
        function onSucceededCallback(sender, args) {
            ...
            markup += 'Refresh this page to see the new title take effect';
...
<asp:Content ID="Main" ContentPlaceHolderID="PlaceHolderMain" runat="server">
    ...
    <h2>
        ...
        <a href="javascript:setWebDetails()">Click Here to Set Web Details</a>
    </h2>
...
<asp:Content ID="PageTitleInTitleArea" ContentPlaceHolderID="PlaceHolderPageTitleInTitleArea" runat="server" >
    Using CSOM to Set Web Properties
</asp:Content>
