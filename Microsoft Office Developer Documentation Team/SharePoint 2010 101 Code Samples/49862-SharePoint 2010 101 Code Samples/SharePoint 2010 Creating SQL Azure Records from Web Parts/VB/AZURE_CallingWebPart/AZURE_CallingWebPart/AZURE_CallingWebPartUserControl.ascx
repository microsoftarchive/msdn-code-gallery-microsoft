...
<%@ Control Language="VB" AutoEventWireup="true" CodeBehind="AZURE_CallingWebPartUserControl.ascx.vb" Inherits="AZURE_CallingWebPart.AZURE_CallingWebPartUserControl" %>
