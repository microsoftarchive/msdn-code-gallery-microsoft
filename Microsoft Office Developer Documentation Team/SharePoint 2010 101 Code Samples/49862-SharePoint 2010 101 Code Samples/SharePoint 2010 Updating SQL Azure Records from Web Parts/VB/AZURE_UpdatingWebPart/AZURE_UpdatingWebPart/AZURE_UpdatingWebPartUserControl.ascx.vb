...
Partial Public Class AZURE_UpdatingWebPartUserControl
    ...
    Protected Sub lnkbtnDelete_Click(ByVal sender As Object, ByVal e As EventArgs) Handles lnkbtnUpdate.Click
        'Get the Products table.
        Dim productsTable As DataTable = productsDataset.Tables(0)
        'Get the first record
        Dim firstProduct As DataRow = productsTable.Rows(0)
