...
<asp:Content ID="PageHead" ContentPlaceHolderID="PlaceHolderAdditionalPageHead" runat="server">
    ...
    <script type="text/javascript">
        //This example gets all the items in the Announcements list.
        ...
        function getListItems() {
            ...
            //Since this example retrieves all items, a blank constructor call is sufficient
            //If you want to filter the items returned, use the caml.ViewXml property to set CAML markup
        ...
        function onSucceededCallback(sender, args) {
            ...
            var markup = 'Items in the Announcements list: <br><br>';
...
<asp:Content ID="Main" ContentPlaceHolderID="PlaceHolderMain" runat="server">
    ...
    <h2>
        ...
        <a href="javascript:getListItems()">Click Here to Query List Items</a>
    </h2>
...
<asp:Content ID="PageTitleInTitleArea" ContentPlaceHolderID="PlaceHolderPageTitleInTitleArea" runat="server" >
    Using CSOM to Retrieve the Items in a List
</asp:Content>
