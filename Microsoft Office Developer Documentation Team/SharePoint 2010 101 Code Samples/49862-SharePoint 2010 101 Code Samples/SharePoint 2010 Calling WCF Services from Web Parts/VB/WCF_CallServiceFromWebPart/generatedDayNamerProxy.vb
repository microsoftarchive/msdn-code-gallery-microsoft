...
<System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0"),  _
 System.ServiceModel.ServiceContractAttribute([Namespace]:="http://WCF_ExampleService", ConfigurationName:="IDayNamer")>  _
Public Interface IDayNamer
    
    <System.ServiceModel.OperationContractAttribute(Action:="http://WCF_ExampleService/IDayNamer/TodayIs", ReplyAction:="http://WCF_ExampleService/IDayNamer/TodayIsResponse")>  _
    Function TodayIs() As String
    
    <System.ServiceModel.OperationContractAttribute(Action:="http://WCF_ExampleService/IDayNamer/TodayAdd", ReplyAction:="http://WCF_ExampleService/IDayNamer/TodayAddResponse")>  _
