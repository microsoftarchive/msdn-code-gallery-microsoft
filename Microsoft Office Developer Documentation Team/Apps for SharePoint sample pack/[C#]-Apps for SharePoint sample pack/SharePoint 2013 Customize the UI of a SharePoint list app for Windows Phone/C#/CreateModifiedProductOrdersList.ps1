...
Creates Product Orders list for SPListAppUICustomization project.
...
(New-Object System.Management.Automation.Host.ChoiceDescription "&No","Keep existing list and quit."))
	...
	try
	{
		...
		$spField = $spList.Fields.Add("Product Category", $spFieldType, $false)
		...
		$spField = $spList.Fields.Add("Rush", $spFieldType, $false)
