...
namespace SPListAppDataValidation
{
    ...
    public static class CamlQueryBuilder
    {
        ...
        /// </summary>
        static string ViewFields = @"<FieldRef Name='Title'/><FieldRef Name='Description'/><FieldRef Name='Quantity'/><FieldRef Name='Order_x0020_Date'/><FieldRef Name='Fulfillment_x0020_Date'/><FieldRef Name='Contact_x0020_Number'/>";
