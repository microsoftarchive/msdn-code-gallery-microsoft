...
namespace MultipleSPListAppSingleProject
{
    ...
    public static class CamlQueryBuilder
    {
        ...
        {   
            ...
            {"View2",   @"<View><Query><OrderBy><FieldRef Name='ID' /></OrderBy></Query><RowLimit>30</RowLimit><ViewFields>{0}</ViewFields></View>"}
        };
        ...
        /// </summary>
        static string View1Fields = @"<FieldRef Name='Title'/><FieldRef Name='FirstName'/><FieldRef Name='JobTitle'/><FieldRef Name='Email'/><FieldRef Name='Comments'/>";
        static string View2Fields = @"<FieldRef Name='Title'/><FieldRef Name='Unit_x0020_Price'/><FieldRef Name='Quantity'/><FieldRef Name='Order_x0020_Value'/><FieldRef Name='Order_x0020_Date'/><FieldRef Name='Status'/><FieldRef Name='Customer'/>";
        ...
        public static CamlQuery GetCamlQuery(string viewName)
        {
            ...
            switch (viewName)
            {
                case "View2":
                    ...
                    break;
                case "View1": // View1 is the default view. This case label is not really needed.
                default:
