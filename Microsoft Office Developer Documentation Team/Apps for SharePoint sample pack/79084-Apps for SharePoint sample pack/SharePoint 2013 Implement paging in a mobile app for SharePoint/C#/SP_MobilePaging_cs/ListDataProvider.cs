...
namespace SP_MobilePaging_cs
{
    ...
    public static class CamlQueryBuilder
    {
        ...
        {   
            ...
            {"View2",   @"<View><Query><OrderBy><FieldRef Name='Country' /><FieldRef Name='Population' /></OrderBy><Where><And><Geq><FieldRef Name='Country' /><Value Type='Text'>A</Value></Geq><Lt><FieldRef Name='Country' /><Value Type='Text'>M</Value></Lt></And></Where></Query><RowLimit>30</RowLimit><ViewFields>{0}</ViewFields></View>"},
            {"View3",   @"<View><Query><OrderBy><FieldRef Name='Country' /><FieldRef Name='Population' /></OrderBy><Where><And><Geq><FieldRef Name='Country' /><Value Type='Text'>M</Value></Geq><Lt><FieldRef Name='Country' /><Value Type='Text'>ZZ</Value></Lt></And></Where></Query><RowLimit>30</RowLimit><ViewFields>{0}</ViewFields></View>"}
        };
        ...
        /// </summary>
        static string ViewFields = @"<FieldRef Name='Country'/><FieldRef Name='Population'/>";
