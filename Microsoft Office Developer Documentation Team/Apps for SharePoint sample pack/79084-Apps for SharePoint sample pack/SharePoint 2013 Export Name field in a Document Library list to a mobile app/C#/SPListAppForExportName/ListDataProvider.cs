...
namespace SPListAppForExportName
{
    ...
    public class ListDataProvider : ListDataProviderBase
    {
        ...
        public override ClientContext Context
        {
            get
            {
                ...
                m_Context = new ClientContext("TargetSite");
    ...
    public static class CamlQueryBuilder
    {
        ...
        {   
            {"View1",   @"<View><Query><OrderBy><FieldRef Name='FileLeafRef' /></OrderBy></Query><RowLimit>30</RowLimit><ViewFields>{0}</ViewFields></View>"}
        };
        ...
        /// </summary>
        static string ViewFields = @"<FieldRef Name='Created'/><FieldRef Name='Author'/><FieldRef Name='Modified'/><FieldRef Name='Editor'/><FieldRef Name='_CopySource'/><FieldRef Name='CheckoutUser'/><FieldRef Name='_UIVersionString'/><FieldRef Name='Title'/>";
