...
namespace SPListAppUICustomization
{
    ...
    public static class CamlQueryBuilder
    {
        ...
        /// </summary>
        static string ViewFields = @"<FieldRef Name='Title'/><FieldRef Name='Description'/><FieldRef Name='Product_x0020_Category'/><FieldRef Name='Quantity'/><FieldRef Name='Order_x0020_Date'/><FieldRef Name='Fulfillment_x0020_Date'/><FieldRef Name='Rush'/><FieldRef Name='Contact_x0020_Number'/><FieldRef Name='Modified'/><FieldRef Name='Created'/><FieldRef Name='Author'/><FieldRef Name='Editor'/><FieldRef Name='_UIVersionString'/><FieldRef Name='Attachments'/>";
