...
#End Region
    ...
    Sub New(ByVal shape As Visio.Shape)
        ...
        ' This constructor method has one parameter, vsoShape, which is the Visio shape that is being converted to a PowerPoint shape.
        vsoShape = shape
        ...
        'cf = 72 * (7.5 / pgHeight) ' Scale conversion factor to account for difference in page dimensions.
        cf = 72
    ...
    Private Sub SetShapeText()
        ...
        ' Get the vertical alignment shape's text.
        ...
        Marshal.FinalReleaseComObject(vsoFont)
    ...
    Private Sub SetShapeLine()
        ...
        ' Set shapeLineWeight variable from th Visio shape border weight.
        shapeLineWeight = CSng(GetVisioStringFromCell("LineWeight").Replace(" pt", ""))

        ' Set shapeLinePattern as Microsoft.Office.Core.MsoLineDashStyle enum (integer)
