    ...
    _getListData$p$0: function Office_Controls_ListView$_getListData$p$0() {
        ...
        requestInfos.success = function(infos) {
            if (infos.statusCode === 200) {
                ...
                context.wpq = $$t_4._getInstanceWPQ$p$0();
                RenderListView(context, $$t_4._getInstanceWPQ$p$0());
                $$t_4._onLoad$p$0();
            }
            else {
    ...
    (function(module) {
        ...
        function DOM_module_def() {
            ...
            function DOM_GetElementsByName(str) {
                ...
                if (ret.length == 0 && Boolean(window.XMLHttpRequest)) {
        ...
        (function() {
            ...
            URI.encodeURIComponent = URI_escapeProperly;
            URI.escapeUrlForCallback = URI_escapeUrlForCallback;
        ...
        function ContextMenu(def) {
            ...
            renderer.RegisterHandler("itemClick", function(evt, menuItem) {
                return (createEventListener.call(this, menuItem.onclick)).call(this, evt, false, menuItem.id);
            });
            renderer.RegisterHandler("itemSelect", function(evt, menuItem) {
                return (createEventListener.call(this, menuItem.onclick)).call(this, evt, true, menuItem.id);
            });
        ...
        function Nav_module_def() {
            ...
            function Nav_isPortalTemplatePage(Url) {
                if (Nav.getUrlKeyValue("PortalTemplate") == "1" || Nav.getUrlKeyValue("PortalTemplate", Boolean(Url)) == "1" || typeof currentCtx != "undefined" && currentCtx != null && typeof currentCtx.isPortalTemplate != "undefined" && currentCtx.isPortalTemplate)
                    return true;
                else
                    return false;
            }
            ...
            function Nav_GetSource(defaultSource) {
                if (typeof GetSource2 == "function") {
                    return URI.encodeURIComponent(GetSource2(defaultSource, null));
                }
                ...
                return URI.encodeURIComponent(Nav.pageUrlValidation(source));
            }
        }
        ...
        function ListModule_afterglass_module_def() {
            ...
            (function() {
                if (!(typeof ListModule.Util != "undefined")) {
            ...
            function List_GetRootFolder(ctxt) {
                ...
                return "&RootFolder=" + URI.encodeURIComponent(RootFolder);
            }
            ...
            function List_FetchEcbInfo(ctxt, id, tagName, fnCallback) {
                ...
                var str = URI.escapeUrlForCallback(ctxt.HttpRoot);
                ...
                var strUrl = rg.join("");
                var req;
                var xmlHttpCtr = window.XMLHttpRequest;
        ...
        function RenderGroupTemplate(renderCtx, group, groupId, listItem, listSchema, level, expand) {
            ...
            iStr += '">';
            if (level == 2)
                iStr += '<img src=' + ListView.ImageBasePath + '"/_layouts/15/images/blank.gif?rev=32"' + ' alt="" height="1" width="10">';
        ...
        function ShowCallOutOrECBWrapper(elm, evt, fShowCallout) {
            (function() {
                if (!false) {
                    if (confirm("Assertion failed: " + "Standalone list view doesn't (yet) support callouts or ECBs." + ". Break into debugger?"))
                        eval("debugger");
                }
            })();
            ;
        ...
        function RenderTableHeader(renderCtx) {
            ...
            ret.push(URI.encodeURIComponent(listSchema.View));
        ...
        function RenderViewSelectorMenu(renderCtx) {
            ...
            ret.push('<img src="');
            ret.push(ListView.ImageBasePath + "/_layouts/15/images/fgimg.png?rev=32");
            ret.push('" alt="');
        ...
        function RenderHeroLink(renderCtx, delay) {
            ...
            if (heroParam.isDocLib && !renderCtx.inGridMode && true) {
                ...
                renderCtx.qcb = new QCB({
                    "buttonClass": "ms-textLarge ms-heroCommandLink js-qcb-button",
        ...
        function InitializeNewDocumentInfo() {
            ...
            docInfo[DocumentType.Word] = new DocumentInformation(DocumentType.Word, 'Word', ListView.ImageBasePath + "/_layouts/15/images/lg_icdocx.png?rev=32", GetString("L_NewDocumentWordImgAlt"), GetString("L_NewDocumentWord"));
            docInfo[DocumentType.Excel] = new DocumentInformation(DocumentType.Excel, 'Excel', ListView.ImageBasePath + "/_layouts/15/images/lg_icxlsx.png?rev=32", GetString("L_NewDocumentExcelImgAlt"), GetString("L_NewDocumentExcel"));
            docInfo[DocumentType.PowerPoint] = new DocumentInformation(DocumentType.PowerPoint, 'PowerPoint', ListView.ImageBasePath + "/_layouts/15/images/lg_icpptx.png?rev=32", GetString("L_NewDocumentPowerPointImgAlt"), GetString("L_NewDocumentPowerPoint"));
            docInfo[DocumentType.OneNote] = new DocumentInformation(DocumentType.OneNote, 'OneNote', ListView.ImageBasePath + "/_layouts/15/images/lg_icont.png?rev=32", GetString("L_NewDocumentOneNoteImgAlt"), GetString("L_NewDocumentOneNote"));
            docInfo[DocumentType.ExcelForm] = new DocumentInformation(DocumentType.ExcelForm, 'ExcelForm', ListView.ImageBasePath + "/_layouts/15/images/lg_icxlsx.png?rev=32", GetString("L_NewDocumentExcelFormImgAlt"), GetString("L_NewDocumentExcelForm"));
            docInfo[DocumentType.Folder] = new DocumentInformation(DocumentType.Folder, 'Folder', ListView.ImageBasePath + "/_layouts/15/images/mb_folder.png?rev=32", GetString("L_NewDocumentFolderImgAlt"), GetString("L_NewDocumentFolder"));
            return docInfo;
        }
        ...
        var ComputedFieldWorker = (function() {
            ...
            function GenBlogLink(link, altText, position, titleText, descText, listSchema, listItem) {
                ...
                ret.push("\" style=\"height:16px;width:16px;display:inline-block;\" ><img src=\"" + ListView.ImageBasePath + "/_layouts/15/images/fgimg.png?rev=32" + "\" alt=\"");
                ret.push(altText);
            ...
            function GetFolderIconSourcePath(listItem) {
                if (listItem["HTML_x0020_File_x0020_Type.File_x0020_Type.mapico"] == '')
                    return ListView.ImageBasePath + "/_layouts/15/images/folder.gif?rev=32";
                else
            ...
            function RenderType(renderCtx, field, listItem, listSchema) {
                ...
                if (listItem.FSObjType == '1') {
                    ...
                    ret.push("?RootFolder=");
                    ret.push(URI.encodeURIComponent(listItem.FileRef));
            ...
            return {
                ...
                Edit: function(renderCtx, field, listItem, listSchema) {
                    if (HasEditPermission(listItem)) {
                        ...
                        ret.push("\" src=\"" + ListView.ImageBasePath + "/_layouts/15/images/edititem.gif?rev=32" + "\"/></a>");
                        return ret.join('');
                    }
                    else {
                        return "&nbsp;";
        ...
        function BusinessDataFieldRendererRenderField(renderCtx, field, listItem, listSchema) {
            ...
            if (Boolean(fieldDefinition.HasActions)) {
                ...
                ret += '<img border="0" align="absmiddle" src=' + ListView.ImageBasePath + "/_layouts/15/images/bizdataactionicon.gif?rev=32" + ' tabindex="0" alt="' + GetString("L_BusinessDataField_ActionMenuAltText") + '" title="' + GetString("L_BusinessDataField_ActionMenuAltText") + '"';
                ret += ' onclick="' + onclickMethod + '"';
                ret += ' onkeydown="' + onKeyDownMethod + '" />';
                ret += '</a>';
                ret += '<a>';
                ret += '<img align="absmiddle" src=' + ListView.ImageBasePath + "/_layouts/15/images/menudark.gif?rev=32" + ' tabindex="0" alt="' + GetString("L_BusinessDataField_ActionMenuAltText") + '"';
                ret += ' onclick="' + onclickMethod + '"';
                ret += ' onkeydown="' + onKeyDownMethod + '" />';
                ret += '</a>';
                ret += '</span>';
        ...
        function RenderUserFieldWorker(renderCtx, field, listItem, listSchema) {
            var g_EmptyImnPawnHtml = "<span class='ms-spimn-presenceLink'><span class='{0}'><img class='{1}' name='imnempty' src='" + ListView.ImageBasePath + "/_layouts/15/images/spimn.png?rev=32" + "' alt='' /></span></span>";
            var g_ImnPawnHtml = "{0}<a href='#' onclick='IMNImageOnClick(event);return false;' class='{1}' {2}>{3}<img name='imnmark' title='' ShowOfflinePawn='1' class='{4}' src='" + ListView.ImageBasePath + "/_layouts/15/images/spimn.png?rev=32" + "' alt='";
            var ret = [];
            ...
            function RenderPicture(fieldToRender) {
                ...
                if (picture == null || picture == '') {
                    ret.push(ListView.ImageBasePath + "/_layouts/15/images/person.gif?rev=32");
                    ret.push("\" alt=\"");
        ...
        function CLVP_InitializePrototype() {
            CLVP.prototype = {
                ...
                wpq: null,
                strHash: "",
                xmlHttpCtr: window.XMLHttpRequest,
                ...
                if (sortNode != null) {
                    ...
                    if (lastNode != null) {
                        ...
                        if (listData.SortDir == "ascending") {
                            ...
                            img.src = "/_layouts/15/images/sort.gif?rev=32";
                        }
                        else {
                            img.alt = GetString("L_viewedit_onetidSortDesc");
                            img.src = "/_layouts/15/images/rsort.gif?rev=32";
                        }
        ...
        function CLVPManageCopies(itemId, fsobjtype) {
            ...
            if (ecb != null && ecb.getAttribute("Url") != null) {
                var url = this.ctx.HttpRoot + "/_layouts/15/managecopies.aspx?ItemUrl=" + URI.encodeURIComponent(ecb.getAttribute("Url")) + "&Source=" + Nav.getSource();
        ...
        function CLVPInplViewUrl() {
            ...
            var rg = [];
            var str = URI.escapeUrlForCallback(this.ctx.HttpRoot);
            ...
            if (typeof this.ctx.IsClientRendering != "undefined" && !this.ctx.IsClientRendering) {
                ...
                rg.push(URI.encodeURIComponent(uri.getStringWithoutQueryAndFragment(), false));
            }
            if (typeof this.ctx.searchTerm != "undefined" && this.ctx.searchTerm != null) {
                rg.push("&InplaceSearchQuery=");
                rg.push(URI.encodeURIComponent(this.ctx.searchTerm, true));
            }
        ...
        function SetUrlKeyValue(keyName, keyValue, bEncode, url) {
            ...
            url = uri.getQuery();
            if (bEncode)
                val = URI.encodeURIComponent(val);
